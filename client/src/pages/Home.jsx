...
const Home = () => {
  ...
  const soloImage =
    "https://images.unsplash.com/photo-1526491109672-74740652b963?q=80&w=2000";
  ...
  useEffect(() => {
    const fetchCommunityTrips = async () => {
      try {
        // Dynamic fetch request based on your deployment environment 🚀
    ...
    fetchCommunityTrips();
  }, [BASE_URL]); // Added BASE_URL dependency to keep useEffect safe
    ...
    <div style={{ paddingBottom: "4rem", background: "#f8fafc" }}>
      ...
      <div
        style={{
          position: "relative",
          height: "600px",
          backgroundImage: `url("${isSolo ? soloImage : groupImage}")`,
          ...
          >
            <button
              ...
              style={{
                ...
                background: !isSolo ? "#0284c7" : "transparent",
                color: !isSolo ? "white" : "#cbd5e1",
                transform: !isSolo ? "scale(1.05)" : "scale(1)",
              }}
            >
              Group Travel
            </button>
            <button
              ...
              style={{
                ...
                cursor: "pointer",
                transition: "all 0.3s ease",
                background: isSolo ? "#10b981" : "transparent",
                color: isSolo ? "white" : "#cbd5e1",
                transform: isSolo ? "scale(1.05)" : "scale(1)",
              }}
            >
                ...
                <div style={{ padding: "1.5rem" }}>
                  ...
                  <Link
                    ...
                    style={{
                      ...
                      fontWeight: "bold",
                      transition: "all 0.3s ease",
                      background: isSolo ? "#ecfdf5" : "#f0f9ff",
                      color: isSolo ? "#047857" : "#0369a1",
                      border: `1px solid ${isSolo ? "#a7f3d0" : "#bae6fd"}`,
                    }}
                  >
